;;; doom-ayu-matugen-dark-theme.el --- inspired by Ayu Dark -*- lexical-binding: t; no-byte-compile: t; -*-
;;
;; Added: July 26, 2026 (#717)
;; Author: qnicoud <https://github.com/qnicoud>
;; Maintainer:
;;
;;; Commentary:
;;; Code:
...
(def-doom-theme doom-matugen
  ...
  (
   ...
   (common-bg       '("{{colors.surface_dim.default.hex}}" "black"   "black"  ))
   (common-line     (doom-darken bg-bright 0.5))
   (common-fg       '("#bfbdb6" "grey"    "grey"   ))
   (common-ui       '("#565b66" "grey"    "grey"   ))
   (test            '("{{colors.primary.default.hex}}" "grey"    "grey"   ))
   ;; syntax
   ...
   (syntax-comment  (doom-blend common-bg common-line 0.5))
   ;;(syntax-comment  '("#475266" "grey"    "grey"   ))
   (syntax-constant '("#a2a6ff" "magenta" "purple" ))
   (syntax-operator '("#f29668" "orange"  "orange" ))
   (syntax-error    '("#d95757" "red"     "red"    ))
   ;; editor
   (editor-selection-active '("{{colors.primary.default.hex}}" "grey" "grey"))
   ;; ui
   (alt-accent            (doom-lighten common-accent 0.4))
   (ui-line               (doom-darken common-bg 0.45))
  ...
  (base0      ui-gutter-normal)
   ...
   (doc-comments   (doom-lighten (if doom-matugen-brighter-comments alt-accent base5) 0.25))
